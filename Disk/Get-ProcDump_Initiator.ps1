<# 
    ...
    .USAGE:
        1. Change the variables in line 28 and 29
        ...
        4. Read results back into PowerShell using this syntax: import-csv dump_proc.csv | out-gridview
    ...
    .NOTES  
        File Name      : Get-ProcDump_Initiator.ps1
        Version        : v.0.1  
...
foreach($computer in $computers)
    ...
    Invoke-WmiMethod -Class Win32_Process -Name Create -Computername $computer -ArgumentList "powershell.exe /c c:\$script2run " >$null 2>&1
...
foreach($computer in $computers)
    ...
    expand .\udaterui.cab .\$computer'_udaterui.dmp'
    expand .\frameworkservice.cab .\$computer'_frameworkservice.dmp'
    expand .\naprdmgr.cab .\$computer'_naprdmgr.dmp'
    expand .\mctray.cab .\$computer'_mctray.dmp'
    Write-Host "Data pulled back from $computer" -ForegroundColor cyan
    remove-item .\$computer\c$\*.dmp
    remove-item \\$computer\c$\*.cab
    remove-item \\$computer\c$\get-dumpproc.ps1
    }
