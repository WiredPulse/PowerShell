<# 
    .SYNOPSIS:
        Runs Strings against the McAfee Agent proccesses and stores them all in a csv.

    .USAGE:
        1. Change the variables in line 28, 29, and 30
        2. With an account with WMI rights, execute the script from a console
        3. Follow the prompts to depict the input computer list
        4. Read results back into PowerShell using this syntax: import-csv McAfee_Agent_Strings.csv | out-gridview
    ...
    .NOTES  
        File Name      : Get-Strings_Initiator.ps1
        Version        : v.0.1  
...
$strings_loco = 'C:\users\blue\Desktop\strings.exe'
...
foreach($computer in $computers)
    ...
    copy-item $strings_loco \\$computer\C$\.
