...
<font face="Arial" size="1"><b>Put a title here!!</b></font><br>
...
Write-Output "Collecting Detail for $Target"
	...
	$MyReport += Get-CustomHeader "2" "General"
		...
		$MyReport += Get-HTMLDetail "Registered Organization" ($OperatingSystems.Organization)
