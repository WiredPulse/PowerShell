<# 
SYNOPSIS:
    Gets a list of Domain Users and compares it with the baseline from the Baseline_Users.txt from the Get-Baseline_Users.ps1 script. 

NOTES:
    - This script should be ran from the Users_Check folder created from the Get-Baseline_Users.ps1 script.
