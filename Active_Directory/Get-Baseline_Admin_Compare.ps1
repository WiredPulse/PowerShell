<# 
SYNOPSIS:
    Gets a list of admins and compares it with the baseline from the Baseline_Admin.txt from the Get-Baseline_Admin.ps1 script. 

NOTES:
    - This script should be ran from the Admin_Check folder created from the Get-Baseline_Admin.ps1 script.
