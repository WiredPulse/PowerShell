...
.EXAMPLE
    PS C:\> .\Invoke-IPv4NetworkScan.ps1 -StartIPv4Address 192.168.178.0 -EndIPv4Address 192.168.178.20
...
.EXAMPLE
    PS C:\> .\Invoke-IPv4NetworkScan.ps1 -IPv4Address 192.168.178.0 -CIDR 25 -EnableMACResolving

        IPv4Address    Status Hostname                   MAC                         Vendor
        -----------    ------ --------                   ---                         ------
        192.168.178.1    Up     test.box            XX-XX-XX-XX-XX-XX         AVM Audiovisuelles Marketing und Computersysteme GmbH
        192.168.178.22   Up     XXXXX-PC.test.box   XX-XX-XX-XX-XX-XX         ASRock Incorporation
