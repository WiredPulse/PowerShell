<#
.SYNOPSIS
    This script will create a temporary webserver on the local system and will listen on the host IP and specified port. You will then be able to post some raw data that 
    will be accessible on the network. When running the script you will be asked what port to listen on and what raw data you to post. This script does not supporting the 
    posting of files or folders. 
...
.EXAMPLE
    ...
    Option 3: Internet browser -- Using the below syntaxto view it in the browser
