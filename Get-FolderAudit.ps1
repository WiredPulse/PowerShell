# Does a recursive audit of a file structure and depicts to the applied permissions. When running the script, you will be asked to input the top-level directory in which you want to start from. 
